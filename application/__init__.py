...
from application.models import Actor, Movie, db_setup
...
def create_app(test_config=None):
    ...
    def update_actor(actor_id):
        ...
        return jsonify({"success": True, "actor updated": actor_id}), 200
    ...
    def delete_actors(actor_id):
        ...
        return jsonify({"success": True, "actor deleted": actor_id}), 200
